...
if __name__ == '__main__':
    ...
    def app():
        # Create a SparkSession #.master("spark://10.86.153.119:7077")
        ...
        df = spark.read \
            ...
            .option("dbtable", "ODI_REPO.HIEUNM_JOIN1") \
            .option("user", "EPOS") \
        ...
        # df_zipped = df_zipped.withColumn('date', date_format(from_unixtime('timestamp').cast(DateType()), 'dd-MM-yyy'))
        #
        # # Store in Minio
        # df_zipped.write \
        #     .mode("overwrite") \
